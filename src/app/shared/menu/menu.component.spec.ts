...
describe('MenuComponent', () => {
  ...
  const mockStatisticSection = { 'id': 'statistics_site', 'active': false, 'visible': false, 'index': 2, 'type': 'statistics', 'model': { 'type': 1, 'text': 'menu.section.statistics', 'link': 'statistics' } };
